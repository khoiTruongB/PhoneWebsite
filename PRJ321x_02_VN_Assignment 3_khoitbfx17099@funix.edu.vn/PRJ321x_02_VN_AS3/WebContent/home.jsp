...
<div class="content">
	...
	<div class="page">
		<ul>
			<c:choose>
				<c:when test="${i==1}">
					<li style="display: none"><a href="productPage?page=${i-1}"><i
							class="bi bi-chevron-double-left"></i></a></li>
				</c:when>
				<c:otherwise>
					<li><a href="productPage?page=${i-1}"><i
							class="bi bi-chevron-double-left"></i></a></li>
				</c:otherwise>
			</c:choose>
			...
			<c:forEach var="i" begin="1" end="${page}">
				<li><a href="productPage?page=${i}">${i}</a></li>
			</c:forEach>
			<!-- page list -->

			<c:choose>
				<c:when test="${i==page}">
					<li style="display: none"><a href="productPage?page=${i+1}">
